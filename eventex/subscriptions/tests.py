...
class SubscribePostTest(TestCase):
    ...
    def test_subcription_email_body(self):
        ...
        self.assertIn('Eric Vieira', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('eric.vieira@me.com', email.body)
        self.assertIn('21-99889-3320', email.body)
...
class SubscribeSucessesMessage(TestCase):

    def test_message(self):
        data =  dict(name='Eric Vieira', cpf='12345678901', email='eric.vieira@me.com', phone='21-99889-3320')
